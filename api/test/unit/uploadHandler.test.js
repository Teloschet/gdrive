...
describe('#UploadHandler test suite', () => {
  ...
  describe('#canExecute', () => {
    test('sould return true when time is later than specified delay', () => {
      ...
      const tickNow = TestUtil.getTimeFromDate('2023-07-26 00:00:03')
      TestUtil.mockDateNow([tickNow])

      const lastExecution = TestUtil.getTimeFromDate('2023-07-26 00:00:00')
    ...
    test('should return false when time isnt later than specified delay', () => {
      ...
      const now = TestUtil.getTimeFromDate('2023-07-26 00:00:02')
      TestUtil.mockDateNow([now])

      const lastExecution = TestUtil.getTimeFromDate('2023-07-26 00:00:01')
